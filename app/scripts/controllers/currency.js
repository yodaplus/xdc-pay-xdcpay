...
class CurrencyController {
  ...
  async updateConversionRate () {
    ...
    try {
      ...
      if (currentCoin === 'poa' || currentCoin === 'etc' || currentCoin === 'xdc') {
        const apiLink = `https://min-api.cryptocompare.com/data/price?fsym=${currentCoin.toUpperCase()}E&tsyms=${currentCurrency.toUpperCase()}`
