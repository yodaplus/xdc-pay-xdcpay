...
exports.isValidAddress = function (address) {
  return /^xdc[0-9a-fA-F]{40}$/i.test(address)
}
...
/**
 * Returns a `Boolean` on whether or not the a `String` starts with "xdc"
 * @param {String} str
 * @return {Boolean}
 */
exports.isHexPrefixed = function (str) {
  return str.slice(0, 3) === 'xdc'
}

/**
 * Removes "xdc" from a given `String`
 * @param {String} str
 * @return {String}
 */
exports.stripHexPrefix = function (str) {
  ...
  return exports.isHexPrefixed(str) ? str.slice(3) : str
}

/**
 * Adds "xdc" to a given `String` if it does not already start with "xdc"
 * @param {String} str
 * @return {String}
 */
exports.addHexPrefix = function (str) {
  ...
  return exports.isHexPrefixed(str) ? str : 'xdc' + str
}
  ...
  self.toJSON = function (label) {
    if (label) {
      ...
      self._fields.forEach(function (field) {
        obj[field] = 'xdc' + self[field].toString('hex')
      })
      return obj
    }
