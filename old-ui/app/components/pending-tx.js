  ...
  return new Promise(async (resolve, reject) => {
    try {
      const response = await fetch(
        "https://1lzur2qul1.execute-api.us-east-2.amazonaws.com/prod/getCoinMarketCap/USD",
        { method: "get" }
      );
      ...
      if (
        ...
        parsedResponse.responseData.length
      ) {
...
PendingTx.prototype.render = function () {
  ...
  if (decodedData && decodedData.name === "transfer") {
    isToken = true;
    const tokenValBN = new BigNumber(
      calcTokenAmount(decodedData.params[1].value, state.tokenDecimals)
    );
              ...
              [
                ...
                h(".row", [
                  ...
                  h(EthBalance, {
                    ...
                    dimStyle,
                    value: isToken
                      ? tokensToSend /* (new BN(tokensToSend)).mul(1e18)*/
                      : txParams.value,
                    currentCurrency,
                    conversionRate,
                    network,
            ...
            [
              h(
                ...
                [
                  ...
                  h("img.cursor-pointer", {
                    src: "/images/Assets/Forward.svg",
                    style: {
                      display:
                        props.index + 1 === props.unconfTxListLength
                          ? "none"
                          : "inline-block",
                      position: "absolute",
                      right: "15px",
