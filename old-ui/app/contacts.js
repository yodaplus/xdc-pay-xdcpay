...
class Contacts extends React.Component {
  ...
  onAddContact = () => {
    ...
    this.props.onAddContactClicked ? this.props.onAddContactClicked() : this.props.dispatch(actions.showAddContactsPage())
  }
        ...
        <div className="list">
          {contactList.length ? (
            contactList.map((contactObj, index) => (
              ...
              >
                {index === 0 ||
                contactList[index].name.charAt(0).toLowerCase() !==
                contactList[index - 1].name.charAt(0).toLowerCase() ? (
                  <div
                    style={{
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() =>
                      state.dispatch(actions.contactDetails(contactObj))
                    }
                  >
                    {contactObj.name}
                  </div>
