    ...
    render(){
        ...
        overflowY: "auto",}}>
            ...
            <div style={{
                ...
                <span style={{ fontWeight: "bold", fontSize: "14px", color: "#2149B9" }}>{`${t('unconnectedAccountWarning')}`}</span>
                <p style={{fontSize:'14px',marginTop:'11px', marginBottom:'20px',fontFamily:'Inter-Medium'}}>{`${t('alertMsg')}`}  </p>
