  ...
  screens: {
    ...
    main: {
      ...
      buttons: {
        ...
        sendXDC: By.css('#app-content > div > div.app-primary.from-left > div > div > div.flex-row > button:nth-child(4)'),
        buyXDC: By.css('#app-content > div > div.app-primary.from-left > div > div > div.flex-row > button:nth-child(3)'),
        sendText: 'Send',
    ...
    buyEther: {
      ...
      faucetLinkXDC: By.className('buy-option cursor-pointer'),
      buttonArrow: By.className('fa fa-arrow-left fa-lg cursor-pointer'),
    },
    info: {
      title: By.className('section-title flex-row flex-center'),
