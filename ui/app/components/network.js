...
Network.prototype.render = function () {
  ...
  } else if (providerName === 'xinfin') {
    hoverText = context.t('xinfin')
    iconName = 'xinfin-network'
  } else if (providerName === 'apothem') {
    hoverText = context.t('apothem')
    iconName = 'apothem-network'
  } else {
